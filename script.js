...
function displayQuestions(data, subject, cls) {
  ...
  questionsDiv.innerHTML = `
      ...
      ${
        isBasicVersion
          ? '<div class="basic-version-badge">Basic Version - Limited to 10 questions</div>'
          : ""
      }
    ...
    questionsDiv.innerHTML += `
      <div class="upgrade-banner-exam">
        ...
        <a href="https://binapayment.vercel.app" class="btn-upgrade-small" target="_blank">
          Upgrade to Pro (₦5,000 Lifetime) <i class="fas fa-arrow-right"></i>
        </a>
      </div>
  ...
  if (isBasicVersion) {
    questionsDiv.innerHTML = `
      <div class="results-container">
        ...
        <div class="upgrade-banner-results">
          <h3>Upgrade to Pro for More Benefits:</h3>
          <ul class="pro-benefits-list">
            <li><i class="fas fa-check-circle"></i> 20 questions per exam</li>
            <li><i class="fas fa-check-circle"></i> All subjects and classes</li>
            <li><i class="fas fa-check-circle"></i> Detailed performance analytics</li>
            <li><i class="fas fa-check-circle"></i> Save your progress</li>
            <li><i class="fas fa-check-circle"></i> Track improvement over time</li>
          </ul>
          <a href="https://binapayment.vercel.app" class="btn-upgrade-large" target="_blank">
            Upgrade to Pro for ₦5,000 (Lifetime Access) <i class="fas fa-crown"></i>
          </a>
        </div>
